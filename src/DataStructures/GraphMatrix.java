...
/* ==========  Graph (Undirected Weighted Adjacency Matrix with Dijkstra) ========== */
public class GraphMatrix<T extends Comparable<T>> implements Graph<T> {
    ...
    public void addVertex(T vertex) { if (!vertices.containsKey(vertex)) vertices.insert(vertex, vertexCount++); }
    ...
    public boolean hasVertex(T vertex) { return vertices.containsKey(vertex); }
